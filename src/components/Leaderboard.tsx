...
// Extended leaderboard entry interface to include difficulty
...
const Leaderboard: React.FC = () => {
    ...
    const unsubscribe = onSnapshot(
      ...
      (snapshot) => {
        ...
        snapshot.docs.forEach((doc) => {
          ...
          if (
            !uniqueEntries.has(data.userId) ||
            uniqueEntries.get(data.userId).score < data.score
          ) {
  ...
  // Get game type icon based on selected game type
  ...
  // Get difficulty color class based on selected difficulty
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-400 to-blue-600">
      <div className="max-w-4xl mx-auto px-4 py-8">
        <div className="flex flex-col items-center mb-8">
          {getGameTypeIcon()} {/* Display game type icon */}
        ...
        <div className="bg-white rounded-xl shadow-xl overflow-hidden">
          ...
          <div className="p-6">
            ...
            <div className="space-y-4">
              ...
              {leaderboard.map((entry, index) => (
                ...
                >
                  <div className="flex items-center space-x-4">
                    ...
                    >
                      {getRankIcon(index)} {/* Display rank icon */}
                    </div>
                    <div>
                      <p
              ...
              {/* Message if no scores are available */}
              {leaderboard.length === 0 && (
                <div className="text-center py-12">
                  <Trophy className="mx-auto mb-4 text-gray-400" size={48} />
                  <p className="text-lg text-gray-500 mb-6">
                    No scores yet for {gameType} ({difficulty}). Be the first to
                    play!
                  </p>
                  <Link
                    to="/game"
