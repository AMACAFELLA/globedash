          ...
          >
            ...
            <div className="text-left">
              ...
              <p className="text-sm text-emerald-100">
                Discover lesser-known but fascinating locations
              </p>
            </div>
          </button>
          {/* Continent Challenge Game Type Button */}
          <button
          ...
          >
            ...
            <div className="text-left">
              ...
              <p className="text-sm text-purple-100">
                Test your knowledge continent by continent
              </p>
            </div>
          </button>
        </div>
